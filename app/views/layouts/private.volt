        ...
        <div class="nav-collapse">
          ...
          <ul class="nav">
            ...
            {%- set menus = [
              ...
              'Users': '_phalcon/vokuro/users',
              'Profiles': '_phalcon/vokuro/profiles',
              'Permissions': '_phalcon/vokuro/permissions'
            ] -%}
        ...
        <ul class="nav pull-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>{{ link_to('_phalcon/vokuro/users/changePassword', 'Change Password') }}</li>
            </ul>
          </li>
